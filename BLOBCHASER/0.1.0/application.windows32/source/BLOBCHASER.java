...
public class BLOBCHASER extends PApplet {
...
public void timeDisplay()
{
  ...
  fill(0); // Makes text black.
  textAlign(CENTER);
  text("TIME: " + PApplet.parseInt(timeRounded), width/10*7, height/8); // Displays the time.
}
...
public void setup()
{
   // Sets canvas size to 500x500 pixels.
...
public void draw()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BLOBCHASER" };
    if (passedArgs != null) {
